...
class Enemy_Tank(GameSprite):
    def __init__(self, x, y, player_tank, enemy_bullets):
        super().__init__('textures/enemy.png', x, y, 50, 50, 2)
...
class SuperEnemyTank(GameSprite):
    ...
    def move(self):
        ...
        if self.direction == "up":
            self.rect.y -= self.speed
            self.image = pygame.transform.scale(pygame.image.load("textures/large_enemy_u.png"), (self.width, self.height))
        elif self.direction == "down":
            self.rect.y += self.speed
            self.image = pygame.transform.scale(pygame.image.load("textures/large_enemy_d.png"), (self.width, self.height))
        elif self.direction == "left":
            self.rect.x -= self.speed
            self.image = pygame.transform.scale(pygame.image.load("textures/large_enemy_l.png"), (self.width, self.height))
        elif self.direction == "right":
            self.rect.x += self.speed
            self.image = pygame.transform.scale(pygame.image.load("textures/large_enemy_r.png"), (self.width, self.height))
    ...
    def fire(self):
        bullet = EnemyBullet("textures/bullet_u.png", self.rect.centerx, self.rect.bottom, 15, 20, 5, self.player_tank)
        self.enemy_bullets.add(bullet)
